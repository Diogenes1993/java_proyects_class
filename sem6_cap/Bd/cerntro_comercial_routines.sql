...
--
-- Host: 127.0.0.1    Database: cerntro_comercial
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `vw_ij_cate_pro`
--

DROP TABLE IF EXISTS `vw_ij_cate_pro`;
/*!50001 DROP VIEW IF EXISTS `vw_ij_cate_pro`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_ij_cate_pro` AS SELECT 
 1 AS `PK_ID_PRODUCTO`,
 1 AS `NOMBRE_PRODUCTO`,
 1 AS `IMAGEN_PRODUCTO`,
 1 AS `NOMBRE_CATEGORIA`,
 1 AS `IMAGEN_CATEGORIA`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `vw_ij_cate_pro`
--
...
/*!50001 VIEW `vw_ij_cate_pro` AS select `p`.`PK_ID_PRODUCTO` AS `PK_ID_PRODUCTO`,`p`.`NOMBRE_PRODUCTO` AS `NOMBRE_PRODUCTO`,`p`.`IMAGEN_PRODUCTO` AS `IMAGEN_PRODUCTO`,`c`.`NOMBRE_CATEGORIA` AS `NOMBRE_CATEGORIA`,`c`.`IMAGEN_CATEGORIA` AS `IMAGEN_CATEGORIA` from (`productos` `p` join `categoria` `c` on((`p`.`FK_ID_CATEGORIA` = `c`.`PK_ID_CATEGORIA`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Dumping events for database 'cerntro_comercial'
--

--
-- Dumping routines for database 'cerntro_comercial'
--
...
UPDATE PRODUCTOS
   SET NOMBRE_PRODUCTO = IFNULL(vin_nombre,NOMBRE_PRODUCTO),
		FK_ID_CATEGORIA= CASE WHEN vin_categoria=0 THEN FK_ID_CATEGORIA ELSE vin_categoria END,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_ELIMINAR_CATEGORIA`(IN vin_id_categoria INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_ELIMINAR_PRODUCTO`(IN vin_id_producto INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_FILTRAR_X_CATEGORI` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_FILTRAR_X_CATEGORI`(IN inv_nombre_categoria VARCHAR(50))
BEGIN
...
-- Dump completed on 2023-09-26  3:42:06
