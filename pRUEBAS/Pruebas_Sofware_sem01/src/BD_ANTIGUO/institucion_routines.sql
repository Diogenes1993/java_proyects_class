...
BEGIN 
		SELECT MATRICULA,NOMBRE,APELLIDO_PATERNO,APELLIDO_MATERNO,EDAD,SEXO FROM ALUMNO
        WHERE CONCAT(MATRICULA,NOMBRE,APELLIDO_PATERNO,APELLIDO_MATERNO,EDAD,SEXO) LIKE CONCAT('%',buscado,'%');
...
-- Dump completed on 2023-08-31 23:47:27
